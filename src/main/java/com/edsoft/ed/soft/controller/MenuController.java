        ...
        List<MenuItem> menuItems = null;
            ...
            if (lang.equalsIgnoreCase("TR")) {
                menuItems = List.of(
                        ...
                        new MenuItem("Rakı", "Göbek 20 cl.", new BigDecimal("1000"), Category.Raki),
                        new MenuItem("Rakı", "Göbek 35 cl.", new BigDecimal("1500"), Category.Raki),
                        new MenuItem("Rakı", "Göbek 50 cl.", new BigDecimal("2000"), Category.Raki),
                        new MenuItem("Rakı", "Göbek 70 cl.", new BigDecimal("2400"), Category.Raki),
                        new MenuItem("Rakı", "Göbek 100 cl.", new BigDecimal("3200"), Category.Raki),
