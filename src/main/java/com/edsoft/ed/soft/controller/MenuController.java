        ...
        List<MenuItem> menuItems = null;
            ...
            if (lang.equalsIgnoreCase("TR")) {
                menuItems = List.of(
                        ...
                        new MenuItem("Antrikot", "Izgara antrikot, yumuşak ve sulu.", new BigDecimal("900"), Category.MainCourses),
                        new MenuItem("Kuzu Lokum", "Lokum kıvamında kuzu eti.", new BigDecimal("800"), Category.MainCourses),
                        ...
                        new MenuItem("Rakı", "Beylerbeyi Göbek 20 cl.", new BigDecimal("1000"), Category.Raki),
                        new MenuItem("Rakı", "Beylerbeyi Göbek 35 cl.", new BigDecimal("1500"), Category.Raki),
                        new MenuItem("Rakı", "Beylerbeyi Göbek 50 cl.", new BigDecimal("2000"), Category.Raki),
                        new MenuItem("Rakı", "Beylerbeyi Göbek 70 cl.", new BigDecimal("2400"), Category.Raki),
                        new MenuItem("Rakı", "Beylerbeyi Göbek 100 cl.", new BigDecimal("3200"), Category.Raki),

                        new MenuItem("Rakı", "Beylerbeyi Mavi 20 cl.", new BigDecimal("900"), Category.Raki),
                        new MenuItem("Rakı", "Beylerbeyi Mavi 35 cl.", new BigDecimal("1400"), Category.Raki),
                        new MenuItem("Rakı", "Beylerbeyi Mavi 50 cl.", new BigDecimal("1900"), Category.Raki),
                        new MenuItem("Rakı", "Beylerbeyi Mavi 70 cl.", new BigDecimal("2200"), Category.Raki),
                ...
                menuItems = List.of(
                        ...
                        new MenuItem("Shrimp", "Sautéed shrimp with butter and Zakkum’s special sauce.", new BigDecimal("850"), Category.HotStarters),
                        ...
                        new MenuItem("Ribeye", "Grilled, tender and juicy steak.", new BigDecimal("900"), Category.MainCourses),
                        new MenuItem("Lamb Delight", "Extremely tender lamb cuts.", new BigDecimal("800"), Category.MainCourses),
                        new MenuItem("Lamb Skewers", "Special grilled lamb skewers.", new BigDecimal("800"), Category.MainCourses),
                        new MenuItem("Grilled Meatballs", "Homemade beef meatballs.", new BigDecimal("600"), Category.MainCourses),
