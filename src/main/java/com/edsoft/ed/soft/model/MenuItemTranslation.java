...
public class MenuItemTranslation {
    ...
    public MenuItemTranslation(String lang, String name, String description, MenuItem menuItem) {
        this.lang = lang;
        this.name = name;
    ...
    public MenuItemTranslation(Long id, String lang, String name, String description, MenuItem menuItem) {
        this.id = id;
        this.lang = lang;
        this.name = name;
        this.description = description;
